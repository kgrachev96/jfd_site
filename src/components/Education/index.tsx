                ...
                <div className="container">
                    <div id="edu_content">
                        <div className="edu_text">
                            <h1>Образование</h1>
                            <p>Я люблю изучать новые технологии и стараюсь их применять как в личных, так и в рабочих проектах. <br />Это помогает мне оттачивать свое мастерство и добиваться хороших успехов в моём деле.</p>
                        </div>
